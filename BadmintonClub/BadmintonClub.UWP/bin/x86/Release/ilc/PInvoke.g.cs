...
namespace __Interop
{
	...
	public unsafe static partial class api_ms_win_core_localization_l1_2_0_dll
	{
		...
		[global::System.Runtime.InteropServices.McgPInvokeMarshalStub("Microsoft.AppCenter, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "Microsoft.AppCenter.Windows.Shared.Utils.CultureInfoHelper", "GetLocaleInfoEx")]
		public static int GetLocaleInfoEx(
					string lpLocaleName, 
					uint LCType, 
					global::System.Text.StringBuilder lpLCData, 
					int cchData)
		{
			// Setup
			ushort* unsafe_lpLocaleName = default(ushort*);
			ushort* unsafe_lpLCData = default(ushort*);
			int unsafe___value;
			try
			{
				// Marshalling
				fixed (char* pinned_lpLocaleName = lpLocaleName)
				{
					...
					if (lpLCData == null)
						unsafe_lpLCData = null;
					else
					{
						unsafe_lpLCData = (ushort*)global::__Interop.McgHelpers.CoTaskMemAllocAndZeroMemory(new global::System.IntPtr(checked(lpLCData.Capacity * 2 
											+ 2)));
						if (unsafe_lpLCData == null)
			...
			finally
			{
				// Cleanup
				if (unsafe_lpLCData != null)
					global::System.Runtime.InteropServices.ExternalInterop.SafeCoTaskMemFree(unsafe_lpLCData);
			}
		}
		...
		[global::System.Runtime.InteropServices.McgGeneratedMarshallingCode]
		[global::System.Runtime.InteropServices.McgPInvokeMarshalStub("System.Text.Encoding.CodePages, Version=4.0.2.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", "Interop+mincore", "GetCPInfoExW")]
	...
	public unsafe static partial class bcrypt_dll
	{
		...
		// Signature, BCryptGenRandom, [fwd] [return] [Mcg.CodeGen.EnumMarshaller] Interop_BCrypt_NTSTATUS__System_Security_Cryptography_Algorithms__Interop_BCrypt_NTSTATUS__System_Security_Cryptography_Algorithms, [fwd] [in] [Mcg.CodeGen.BlittableValueMarshaller] System_IntPtr____w64 int, [fwd] [in] [Mcg.CodeGen.BlittableValueMarshaller] byte___ptrunsigned char *, [fwd] [in] [Mcg.CodeGen.BlittableValueMarshaller] int__int, [fwd] [in] [Mcg.CodeGen.BlittableValueMarshaller] int__int, 
		[global::System.Runtime.InteropServices.McgGeneratedMarshallingCode]
		...
		public static global::Interop_BCrypt_NTSTATUS__System_Security_Cryptography_Algorithms BCryptGenRandom(
	...
	public unsafe static partial class bcrypt_dll_PInvokes
	{
		...
		[global::System.Runtime.InteropServices.McgGeneratedNativeCallCode]
		[global::System.Runtime.InteropServices.DllImport("bcrypt.dll", CallingConvention=global::System.Runtime.InteropServices.CallingConvention.Winapi)]
		public extern static global::Interop_BCrypt_NTSTATUS__System_Security_Cryptography_Algorithms BCryptGenRandom(
					global::System.IntPtr hAlgorithm, 
					byte* pbBuffer, 
					int cbBuffer, 
					int dwFlags);
